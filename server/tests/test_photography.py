...
class TestAuroraColorPrediction:
    ...
    def test_kp_9_green_and_red(self):
        settings = _get_recommended_settings(9)
        assert "Green and red" in settings["auroraColor"]
